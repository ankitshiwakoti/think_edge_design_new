        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={4} lg={3}>
            <Row>
              ...
              <div
                class="input-group input-group-sm mb-3 rounded-0"
                style={{ textDecoration: "none" }}
              >
                <input
                  type="text"
                  className=" rounded-0 p-2 folfont text-primary border border-end-0 bg-transparent "
                ...
                />
                <span
                  className="rounded-0 p-2 input-group-text bg-transparent border-start-0 "
